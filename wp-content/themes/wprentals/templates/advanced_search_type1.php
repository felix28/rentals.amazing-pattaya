...
<div class="adv-search-1 <?php echo $google_map_lower_class.' '.$close_class.' '.$extended_class;?>" id="adv-search-1" data-postid="<?php echo $post_id; ?>"> 
    ...
    <form  method="get"  id="main_search" action="<?php print $adv_submit; ?>" >
        ...
        <!--<div class="col-md-4 map_icon">-->    
            ...
            ?>
            <input type="hidden" value="Pattaya"   id="search_location<?php echo $wpestate_internal_search;?>"      class="form-control" name="search_location" placeholder="<?php esc_html_e('Where do you want to go ?','wpestate');?>" value="" >              
